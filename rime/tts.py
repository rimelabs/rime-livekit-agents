...
class RimeTTS(tts.TTS):
    def __init__(
        ...
        *,
        ...
        tts_options: RimeTTSOptions = RimeTTSOptions(),
        ...
        super().__init__(
            ...
            sample_rate=tts_options.sample_rate,
        ...
        self._headers = {
            ...
            "accept": f"audio/{tts_options.audioFormat}",
        }


        self._logger = logger
        self._opts = tts_options
...
class ChunkedStream(tts.ChunkedStream):
    ...
    async def _run(self) -> None:
        ...
        payload = {
            ...
            "audioFormat": self._opts.audioFormat
        }
        ...
        try:
            self._logger.info(f"Sending request to API {self._url} with payload: {json.dumps(payload)}")
